    ...
    <div className="bg-white">
      ...
      <div className="bg-gray-50 border-b border-gray-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-3 text-xs text-gray-500">
          ...
          <Link href="/#services" className="hover:text-indigo-600">서비스</Link>
          <span className="mx-2 text-gray-300">/</span>
      ...
      <section className="relative border-b border-gray-100">
        <div className="absolute left-0 top-0 bottom-0 w-1.5 bg-indigo-600 pointer-events-none" />
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 md:py-24">
          ...
          <div className="flex flex-wrap items-center gap-3 text-sm">
            <Link
              ...
              className="px-5 py-2.5 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 font-semibold shadow-sm transition-all"
            >
              VDI 기술지원 문의
            </Link>
            <Link
      ...
      {/* AEO 정의 문장 */}
      <section className="border-b border-gray-100 bg-indigo-50/40">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-10">
          <p className="text-base sm:text-lg text-gray-800 leading-relaxed kr-keep-all">
            <span className="font-semibold text-indigo-700">VDI 기술지원</span>은 Citrix, Omnissa
            Horizon, VMware 기반 가상 데스크톱 환경의 접속장애, 인증서, 프로파일, UAG/Gateway,
            vSphere 연계 문제를 분석하는 서비스입니다.
          </p>
        </div>
      </section>
      ...
      <section className="bg-slate-900 text-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-14 md:py-16">
          <p className="text-indigo-300 font-semibold text-xs sm:text-sm mb-3 tracking-widest uppercase">
            Contact
          </p>
