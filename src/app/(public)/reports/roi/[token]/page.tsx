  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        {/* PDF Save */}
        <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm mb-6 flex items-center justify-between gap-4 print:hidden">
          <div>
            <h3 className="font-semibold text-gray-900">경영진 보고용 PDF</h3>
            <p className="text-sm text-gray-500 mt-0.5">
              리포트를 PDF로 저장하여 경영진과 공유하세요.
            </p>
          </div>
          <PrintPdfButton />
        </div>
