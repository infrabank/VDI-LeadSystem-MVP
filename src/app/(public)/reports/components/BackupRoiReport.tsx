        ...
        <div className="max-w-3xl mx-auto px-4 pt-10 pb-8">
          <div className="flex items-start justify-between gap-4 flex-wrap">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-2 leading-relaxed [word-break:keep-all]">
                {summary}
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              <div className="flex items-baseline justify-between mb-2">
                <span className="text-sm font-semibold text-gray-700">현 환경 5년 누적</span>
            ...
            {scenarioCards.map(({ label, sub, data, highlight }) => (
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  <span className={`text-xs font-bold uppercase tracking-wide ${highlight ? "text-emerald-700" : "text-gray-500"}`}>
                    {label}
                  </span>
                  {highlight && (
                ...
                <p className="text-xs text-gray-500 mb-3 [word-break:keep-all]">{sub}</p>
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-4 md:p-6">
            ...
            <ol className="space-y-3">
              {recommendations.map((rec, i) => (
                <li
                  key={i}
                  className="flex gap-3 p-3.5 border border-gray-200 border-l-4 border-l-emerald-400 rounded-lg"
                >
                  ...
                  <p className="text-sm text-gray-700 leading-relaxed pt-0.5 [word-break:keep-all]">
                    {rec}
                  </p>
                </li>
              ))}
