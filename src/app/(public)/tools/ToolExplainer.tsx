...
const CONTENT: Record<ToolSlug, ExplainerContent> = {
  "risk-assessment": {
    ...
    outputs: [
      ...
      "MFA를 어디에 어떤 정책으로 적용할지 짚는 보완 지점",
      "백업·DR 보완 지점",
      "1쪽 요약 PDF",
    ],
    audience: [
    ...
    faq: [
      {
        ...
        a: "아닙니다. 입력값 기준의 예비 분류입니다. 실제 등급은 기관의 업무 분류 체계와 소관 부처 판단이 함께 들어가야 확정됩니다. 이 결과는 내부 논의를 시작하는 초안으로 보시면 됩니다.",
      },
      {
    ...
    faq: [
      {
        ...
        a: "입력값 기준의 추정치입니다. 실제 견적은 라이선스 조건, 기존 자산 잔존가, 기관별 조달 단가에 따라 달라집니다. 내부 검토용 초안으로만 쓰셔야 합니다.",
      },
    ],
    related: [
