...
const tools = [
  {
    rank: "01",
    title: "N²SF 정렬 진단",
    desc: "N²SF 보안통제 매핑 기반 · 8개 영역 · 28개 문항 · 업무 등급별 적용 가능 모델 후보",
    duration: "약 7분",
  ...
  },
  {
    rank: "02",
    title: "N²SF 전환 준비도",
    desc: "5개 영역 · 15개 문항 · 5단계 성숙도 + 3단계 로드맵",
    duration: "약 3분",
  ...
  },
  {
    rank: "03",
    title: "VDI 역할 재정의",
    desc: "9개 문항 · 4가지 시나리오 후보 도출 (유지/보완/축소/재설계)",
    duration: "약 2분",
  ...
  },
  {
    ...
    desc: "7개 영역 · 25개 문항 · 5단계 성숙도 + 보완 우선순위",
    duration: "약 7분",
    icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z",
    color: "var(--color-domain-backup)",
