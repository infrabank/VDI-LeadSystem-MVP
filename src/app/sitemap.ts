...
const staticPaths: { path: string; priority: number; changeFrequency: MetadataRoute.Sitemap[number]["changeFrequency"] }[] = [
  ...
  { path: "/tools/vdi-ops-checklist", priority: 0.7, changeFrequency: "monthly" },
  { path: "/tech-notes", priority: 0.6, changeFrequency: "weekly" },
  ...
  { path: "/products/vdiops", priority: 0.9, changeFrequency: "monthly" },
